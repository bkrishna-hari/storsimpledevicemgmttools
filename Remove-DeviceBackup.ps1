<#
.DESCRIPTION
    This scipt deletes a single backup object.
    ...
    4.  Download the script from script center. 
            ...
            .\Remove-DeviceBackup.ps1 -SubscriptionId [subid] -TenantId [tenantid] -ResourceGroupName [resource group] -ManagerName [device manager] -DeviceName [device name] -BackupName [backup name] -AuthNType [Type of auth] -AADAppId [AAD app Id] -AADAppAuthNKey [AAD App Auth Key]
...
.PARAMS 
    ...
    BackupName: Input the name of the Backup to use to delete the backup object.
...
(
    ...
    [parameter(Mandatory = $true, HelpMessage = "Input the name of the Backup to use to delete the backup object.")]
    [String]
    $BackupName,
